...
<html>
	...
	<body onload="startTime()">
		<div class="container col-md-12 codebody">
			...
			<center><p class="title">PHP Age Calculator with Datepicker</p></center>
			<form method = "post">
		...
		<div class="alert" style="text-align:center;">
			<p style="margin-top:-60px;">
				<a href="https://www.sourcecodester.com/htmlcss/11285/text-reveal-mouse-hover.html" class="btn btn-primary" target="_blank">Download Source Code</a>
			</p>
		</div>
	</body>
</html>